...
def build_georef(tab_path):
    ...
    return dict(
        ...
        gcp_note="3 GCPs are nearly collinear and mutually inconsistent at the "
                 "few-meter level; similarity fit used, residuals above. Add a "
                 "4th well-spread GCP in QGIS to tighten the scale.",
